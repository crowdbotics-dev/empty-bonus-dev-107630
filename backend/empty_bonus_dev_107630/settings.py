"""
Django settings for empty_bonus_dev_107630 project.
...
ROOT_URLCONF = 'empty_bonus_dev_107630.urls'
...
WSGI_APPLICATION = 'empty_bonus_dev_107630.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_bonus_dev_107630 API",
    "DESCRIPTION": "API documentation for empty_bonus_dev_107630 App",
    "VERSION": "v1",
}
